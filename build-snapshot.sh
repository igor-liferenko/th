...
uci commit system
EOF
make image PROFILE=Generic PACKAGES="nfs-utils kmod-fs-nfs kmod-usb-ohci kmod-usb-acm kmod-usb-hid kmod-hid-generic kmod-usb-serial-ftdi mpc" FILES=files/
